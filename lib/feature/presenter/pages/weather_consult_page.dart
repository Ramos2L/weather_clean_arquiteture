...
import 'blocs/weather_consult_bloc.dart';


class WeatherConsultPage extends ConsumerStatefulWidget {
  const WeatherConsultPage({super.key});

  @override
  ConsumerState<WeatherConsultPage> createState() => _WeatherConsultPageState();
}

class _WeatherConsultPageState extends ConsumerState<WeatherConsultPage> {
  ...
  void initState() {
    ...
    super.initState();
    final bloc = ref.read(weatherBloc);
      ...
      body: BlocBuilder<WeatherConsultBloc, WeatherConsultState>(
        ...
        builder: (BuildContext context, state) {
          if (state is WeatherConsultLoading) {
            ...
            //error
            _weather = state.weather as WeatherModel?;
            return Center(
              child: Column(
